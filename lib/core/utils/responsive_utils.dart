...
///
/// Screen-size questions only. The reader's column width is a *typographic*
/// question — it is measured in multiples of the paragraph's own font size —
/// so it lives with the type, on `TextEntryTheme.readingPadding`.
///
/// Breakpoints:
/// - Mobile: < 768px (phones)
/// - Tablet: 768px - 1023px
