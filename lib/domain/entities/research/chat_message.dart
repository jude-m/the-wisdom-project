...
/// Role values for [ChatMessage.role]. Match the `/research` history contract
...
///
/// The `/research` `history` array only carries `{role, content}` (§7); [citations]
...
class ChatMessage with _$ChatMessage {
  ...
  /// Wire shape for the `/research` `history` array — role + content only.
