...
_$ReaderTabImpl _$$ReaderTabImplFromJson(Map<String, dynamic> json) =>
    _$ReaderTabImpl(
      ...
      landingPageIndex: (json['landingPageIndex'] as num?)?.toInt(),
      landingEntryIndex: (json['landingEntryIndex'] as num?)?.toInt(),
...
Map<String, dynamic> _$$ReaderTabImplToJson(_$ReaderTabImpl instance) =>
    <String, dynamic>{
      ...
      'landingPageIndex': instance.landingPageIndex,
      'landingEntryIndex': instance.landingEntryIndex,
