...
/// Maps a transport [ApiException] (or any unexpected error) from the `/ask`
...
/// the UI re-localises by [ApiErrorType] (see ask_error_messages.dart).
Failure mapAskError(Object e) {
