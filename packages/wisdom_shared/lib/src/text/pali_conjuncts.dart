...
///
/// Pure Dart, shared by every surface that displays Pali. The Flutter reader
/// applies it at render time from the user's switches; the static-site
/// generator bakes the *default* switches straight into the HTML (build plan
/// D1), because a static page has no settings screen. Both call this file — a
/// second implementation on the web side would silently render different
/// conjuncts than the app for the same text.
///
