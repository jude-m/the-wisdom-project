...
///
/// The static-site generator has no settings screen, so it bakes
/// [PaliLetterOptions.defaults] into the HTML at build time (build plan D1).
/// That is the same object the app starts from, which is what keeps a shared
/// page and the app showing the same conjuncts.
///
